...
symbols = snp500['Symbol'].sort_values().to_list()


ticker = st.sidebar.selectbox('Choose a Symbol',symbols)
...
if (infoType == 'Fundamental'):
    ...
    #Generation of Moving Average Indicator
    ...
    #Generation of Bollinger Bands Indicator
